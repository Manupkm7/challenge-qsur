 ...
 * - `onSave`: Callback para guardar el nuevo producto.
 */
      ...
      <form onSubmit={handleSubmit} className={`${dark ? 'bg-[#30302f] text-white' : 'bg-white'}`}>
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="grid gap-2">
            ...
            />
            {error.price && (
              <p data-testid="error-price" className="text-red-500 text-sm">
                {error.price}
              </p>
            )}
          </div>
          <div className="grid gap-2">
            ...
            />
            {error.quantity && (
              <p data-testid="error-quantity" className="text-red-500 text-sm">
                {error.quantity}
              </p>
            )}
          </div>
          ...
          <div className="grid gap-2">
            ...
            />
            {error.description && (
              <p data-testid="error-description" className="text-red-500 text-sm">
                {error.description}
              </p>
            )}
          </div>
          ...
          <div className="grid gap-2">
            ...
            />
            {error.status && (
              <p data-testid="error-status" className="text-red-500 text-sm">
                {error.status}
              </p>
            )}
          </div>
