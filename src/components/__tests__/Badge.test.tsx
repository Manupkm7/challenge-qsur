...
describe('Badge', () => {
  ...
  it('aplica clases personalizadas correctamente', () => {
    render(<Badge variant="default" className="custom-class">Test Badge</Badge>)
  ...
  it('pasa correctamente los atributos HTML adicionales', () => {
    render(<Badge variant="default" data-testid="test-badge" aria-label="Test Badge">Test Badge</Badge>)
