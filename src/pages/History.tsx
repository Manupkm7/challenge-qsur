      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-6">
        <div>
          ...
          <p className="text-muted-foreground select-none">
            Registro de todas las acciones realizadas en las tarjetas
          </p>
        </div>
            ...
            items={[
              {
                content: (
                  <>
                    <span className={actionFilter === 'all' ? 'bg-accent' : ''}>
                      Todas las acciones
                    </span>
                  </>
                ),
              ...
              },
              {
                content: (
                  <>
                    <span className={actionFilter === 'create' ? 'bg-accent' : ''}>Creaciones</span>
                  </>
                ),
              ...
              },
              {
                content: (
                  <>
                    <span className={actionFilter === 'update' ? 'bg-accent' : ''}>
                      Actualizaciones
                    </span>
                  </>
                ),
              ...
              },
              {
                content: (
                  <>
                    <span className={actionFilter === 'delete' ? 'bg-accent' : ''}>
                      Eliminaciones
                    </span>
                  </>
                ),
                  ...
                  <Table.Row key={event.id}>
                    ...
                    <Table.Cell>
                      <Badge
                        ...
                        className={`flex w-fit items-center gap-1 ${dark ? 'text-white' : 'text-black'}`}
                      >
                    ...
                    <Table.Cell className="hidden md:table-cell text-muted-foreground">
                      {event.details}
                    </Table.Cell>
                  </Table.Row>
                );
